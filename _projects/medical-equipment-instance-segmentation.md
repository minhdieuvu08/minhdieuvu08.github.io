...
Twenty configurations across two paradigms, all trained for 60 epochs:

| | Two-stage (MMDetection) | One-stage (YOLO) |
| --- | --- | --- |
| **Frameworks** | Mask R-CNN · Cascade Mask R-CNN · HTC | YOLOv8-Seg · YOLOv11-Seg (S/M/L) |
| **Backbones** | ResNet50/101 · ResNeXt101 · ConvNeXt-T/S/B/L · ConvNeXtv2-T/B/L · PVT-M/L · PVTv2-B3/B4 | — |
...
| Cascade Mask R-CNN + ResNeXt101 | 50.2 | — | 20.4 |
| HTC + PVTv2-B4 | 54.6 | — | 27.7 |
| HTC + ConvNeXt-L | 56.9 | — | **33.5** |
...
that is not a slow solution — it is not a solution.
