...
Algorithm practice in C++, filed by technique rather than by problem number — the useful unit is the pattern,
not the puzzle.
...
reasoning and the complexity — writing the argument down is what separates having solved a problem from
